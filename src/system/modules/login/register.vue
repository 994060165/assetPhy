  ...
  <div class="registerForm1">
    <el-dialog :title="tableTitle" :visible="formVisible" :close-on-click-modal="false" :show-close='false'>
         ...
         <el-form :model="form" label-width="160px" ref="form" :rules="formRules">
          <el-col :span="12">
            <el-form-item label="用户ID：" prop="UserID">
              <el-input v-model="form.UserID" auto-complete="off" placeholder="【请输入4-25位的数字英文组合！】"></el-input>
            </el-form-item>
      ...
      <div slot="footer" class="dialog-footer">
        ...
        <el-button type="primary" @click.native="sysAddSubmit" :loading="formLoading">注册</el-button>
      </div>
    </el-dialog>
  </div>
</template>
